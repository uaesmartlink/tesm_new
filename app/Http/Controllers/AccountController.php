    ...
    public function update(Request $request)
    {
        $v = $this->validate(
            ...
            [
                ...
                'MAIL_DRIVER'            => 'max:191|required_if:email_enabled,true|nullable|in:ses,smtp,mailgun,postmark',
                'AWS_ACCESS_KEY_ID'      => 'max:191|required_if:MAIL_DRIVER,ses',
                'AWS_SECRET_ACCESS_KEY'  => 'max:191|required_if:MAIL_DRIVER,ses',
                'AWS_DEFAULT_REGION'     => 'max:191|required_if:MAIL_DRIVER,ses',
                'MAIL_HOST'              => 'max:191|required_if:MAIL_DRIVER,smtp',
                'MAIL_PORT'              => 'max:191|required_if:MAIL_DRIVER,smtp',
                'MAIL_USERNAME'          => 'MAX:191|required_if:MAIL_DRIVER,smtp',
                'MAIL_PASSWORD'          => 'max:191|required_if:MAIL_DRIVER,smtp',
                'MAILGUN_DOMAIN'         => 'max:191|required_if:MAIL_DRIVER,mailgun',
                'MAILGUN_SECRET'         => 'max:191|required_if:MAIL_DRIVER,mailgun',
                'MAILGUN_ENDPOINT'       => 'max:191|required_if:MAIL_DRIVER,mailgun',
                'POSTMARK_TOKEN'         => 'max:191|required_if:MAIL_DRIVER,postmark',
        ...
        $user = $request->user();
        if (demo()) {
            return response()->json(['success' => false, 'message' => __('This actions is not allowed on the demo.')], 422);
        }
