        ...
        <div class="bg-white rounded shadow overflow-hidden max-w-4xl">
          ...
          /> -->
                ...
                <table v-else class="w-full">
                  <thead>
                    <tr>
                      ...
                      <th class="border-b px-4 py-2 bg-gray-200 w-30">
                        {{ $tc("Measurement") }}
                      </th>
                      <th class="border-b px-4 py-2 bg-gray-200 w-12">
                        {{ $t("Price") }}
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <td class="border-b px-4 py-2 no-drop">
                        <div
                          v-if="!getServiceMeasurements(service.service_id)"
                          class="text-center"
                        >
                          <button
                            type="button"
            ...
            <div class="px-8 py-4 bg-gray-100 border-t border-gray-200 flex items-center">
              ...
              <loading-button
                :loading="sending"
                class="btn-gray ltr:ml-auto rtl:mr-auto"
                type="submit"
              >
...
export default {
  ...
  mounted() {
    if (this.order.assigned_to) {
      this.staff = {
        label: this.order.assigned_to.name,
        value: this.order.assigned_to.id,
      };
  ...
  methods: {
    addToOrder(s) {
      ...
      this.form.services.push({
        ...
        service_id: s.id,
        qty: 1,
        measurement_id: measurements ? measurements[0]["id"] : null,
      });
    },
