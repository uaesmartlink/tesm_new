<template>
  <div class="titlebar p-6 bg-gray-800 min-h-screen flex justify-center items-center">
    <div class="w-full max-w-md no-drag">
      ...
      <div class="flex justify-center mx-auto fill-white">
        <div class="h-8 italic text-white text-lg py-1 flex items-center">
          <Icons name="logo" className="w-6 h-6 ltr:mr-2 rtl:ml-2 fill-gray-300 group-hover:fill-white" />
