    ...
    <div class="bg-white rounded shadow overflow-hidden max-w-3xl">
      <form @submit.prevent="submit" autocomplete="off">
        <div class="p-8 ltr:-mr-6 rtl:-ml-6 ltr:ml-0 rtl:mr-0 -mb-8 flex flex-wrap">
          ...
          <!-- <text-input v-model="form.MAIL_DRIVER" :errors="$page.props.errors?.MAIL_DRIVER" class="ltr:pr-6 rtl:pl-6 pb-8 w-full" label="Mail Driver" /> -->
          ...
          <div class="ltr:pr-6 rtl:pl-6 pb-8 w-full">
            ...
            <v-select
              ...
              :class="{ error: errors.MAIL_DRIVER && errors.MAIL_DRIVER.length }"
            ></v-select>
            <div v-if="$page.props.errors?.MAIL_DRIVER" class="form-error">{{ errors.MAIL_DRIVER[0] }}</div>
          </div>
          <div class="w-full"></div>
          <transition-group
            tag="div"
            name="slide-fade"
            v-if="form.MAIL_DRIVER"
            class="w-full bg-gray-200 rounded border px-4 pt-4 mb-6 ltr:mr-6 rtl:ml-6"
          >
            <div class="ml-3 mt-2 w-full" key="postmark" v-if="form.MAIL_DRIVER == 'postmark'">
              <text-input
                class="ltr:pr-6 rtl:pl-6 pb-8 w-full"
            ...
            <div class="ml-3 mt-2 flex flex-wrap w-full" key="mailgun" v-else-if="form.MAIL_DRIVER == 'mailgun'">
              <text-input
            ...
            <div class="ml-3 mt-2 flex flex-wrap w-full" key="ses" v-else-if="form.MAIL_DRIVER == 'ses'">
              <text-input
            ...
            <div class="ml-3 mt-2 flex flex-wrap w-full" key="smtp" v-else-if="form.MAIL_DRIVER == 'smtp'">
              <text-input
...
export default {
  ...
  data() {
    return {
      ...
      form: {
        ...
        MAIL_DRIVER: this.account.MAIL_DRIVER,
  ...
  methods: {
    ...
    submit() {
      ...
      data.append('MAIL_DRIVER', this.form.MAIL_DRIVER || '');
