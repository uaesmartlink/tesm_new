        ...
        <div class="tm_container">
            ...
            <div class="tm_invoice tm_style1" id="tm_download_section">
                    ...
                    <div class="tm_invoice_head tm_align_center tm_mb20">
                        <div class="tm_invoice_left">
                            <div class="tm_logo tm_size1">
                                <img src="{{ $order->account->logo_path }}"/>
                            </div>
                        </div>
                        <div class="tm_invoice_right tm_text_right">
                        <div style="font-size: 8px;">CLOAKS BOUTIQUE</div>
                        <div style="font-size: 8px;">00971504479797</div>
                        <div style="font-size: 8px;">Insta: @cloaksboutique</div>
                        <div style="font-size: 8px;">United Arab Emirates</div>
                        <div style="font-size: 8px;">346671</div>
                        <div style="font-size: 8px;">TRN 100009122100003</div>
                    </div>
                </div>

                <div class="tm_invoice_head tm_mb10" style=" border-bottom: 0.2em solid black;">
                    <div class="tm_invoice_left">
                        <p class="tm_mb2" ><b class="tm_primary_color">Prepared For</b></p>
                        <p>
                    ...
                    <div class="tm_invoice_left"style="margin-left:20px;">
                        <p class="tm_mb2"><b class="tm_primary_color">Prepared At</b></p>
                            <p>
                                {{ $order->created_at }}
                            </p>
                        </div>
                    <div class="tm_invoice_left"style="margin-left:20px;">
                        <p class="tm_mb2"><b class="tm_primary_color">Invoice No.</b></p>
                        <p>
                            {{ $order->id }}
                        </p>
                        </div>
                ...
                <div class="tm_table tm_style1 tm_mb40">
                    <div style="widows: 100%; overflow-x:auto;">
                    <div >
                        <table class="tm_table_responsive" style="overflow-x: auto; font-size:8px;">
                        <tbody>
                            <tr>
                                <td class="tm_width_5 tm_text_left" >
                                    Details
                                </td>
                                <td class="tm_width_1 ">
                                    Color
                            ...
                            <tr>
                                <td>
                                    <table style="border:none; m_table">
                                        <tr>
                                            <td class="m_table_td">
                                                L
                                            </td>
